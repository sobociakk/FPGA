...
always_comb begin
    ...
    if((btn_min_tick_i && min_u_q == 4'd9) || en_min_t) begin
...
always_ff @(posedge clk_i) begin
    if (hr_t_d != hr_t_q || hr_u_d != hr_u_q || min_t_d != min_t_q || min_u_d != min_u_q) begin
        $display("[HW PROBE] Wewnetrzny czas RTL zmienil sie na: %0d%0d:%0d%0d", hr_t_d, hr_u_d, min_t_d, min_u_d);
    end
end
